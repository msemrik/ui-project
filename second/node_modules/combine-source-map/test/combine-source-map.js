...
test('relative path from multiple files', function(t) {
  ...
  var gen1Map = {
    ...
    mappings: 'AAAA;ACAA',
    sourcesContent: [ 'console.log(1);', 'console.log(2);' ],
    sourceRoot: '../applications/package1'
  };
  ...
  var gen2Map = {
    ...
    mappings: 'AAAA;ACAA',
    sourcesContent: [ 'console.log(3);', 'console.log(4);' ],
    sourceRoot: '../applications/package2'
  };
  ...
  t.deepEqual(sm.sources, ['applications/package1/sub/one.js', 'applications/package1/sub/two.js', 
    'applications/package2/sub/three.js', 'applications/package2/sub/four.js'], 
  ...
  t.deepEqual(
    ...
    , [ { original: { column: 0, line: 1 },
        generated: { column: 0, line: 1 },
        source: 'applications/package1/sub/one.js',
        name: null },
      { original: { column: 0, line: 1 },
        generated: { column: 0, line: 2 },
        source: 'applications/package1/sub/two.js',
        name: null },
      { original: { column: 0, line: 1 },
        generated: { column: 0, line: 3 },
        source: 'applications/package2/sub/three.js',
        name: null },
      { original: { column: 0, line: 1 },
        generated: { column: 0, line: 4 },
        source: 'applications/package2/sub/four.js',
        name: null } ], 'should properly map multiple files');
  t.end()
});
